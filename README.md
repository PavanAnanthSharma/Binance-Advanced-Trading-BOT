...
## Binance Setup for this tool 

-   Create a [Binance account](https://www.binance.com/
-   Enable Two-factor Authentication.
-   Create a new API key.
-   Get a cryptocurrency. If its symbol is not in the default list, add it.

## BOT setup / Tool setup
...
### How to run this BOT: use the code below !!
...
--------------------------------------------------------------------------------------------------------------------------------------------------------------------------
#Lets hope you enjoyed this tutorial and this crazy BOT, do consider following me here on GitHub and on instagram @pavan_ananth.
